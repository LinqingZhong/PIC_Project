...
class Internlm(object):
    ...
    def predict(self, prompt):
        ...
        system_prompt = "You are an assistant named ChatBot built from internlm 3, which is expert in the energy field. You are developped by six students from ECPK in Beihang University."
        messages = [
