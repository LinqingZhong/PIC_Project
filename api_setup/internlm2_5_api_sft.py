...
class Internlm(object):
    ...
    def __init__(self, model_path="/home/zlq/PIC/internlm2_5"):
    ...
    def predict(self, prompt):
        ...
        system_prompt = "You are an assistant named ChatBot built from internlm 2.5, which is expert in the energy field. You are developped by six students from ECPK in Beihang University."
        messages = [
